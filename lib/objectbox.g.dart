...
final _entities = <ModelEntity>[
  ModelEntity(
      id: const IdUid(1, 1359946532989351171),
      name: 'Note',
      lastPropertyId: const IdUid(3, 5426913318007107260),
      flags: 0,
      properties: <ModelProperty>[
        ModelProperty(
            id: const IdUid(1, 8736904097414655227),
            name: 'id',
            type: 6,
            flags: 1),
        ModelProperty(
            id: const IdUid(2, 6147503630416251524),
            name: 'name',
            type: 9,
            flags: 0),
        ModelProperty(
            id: const IdUid(3, 5426913318007107260),
            name: 'description',
            type: 9,
            flags: 0)
      ],
...
ModelDefinition getObjectBoxModel() {
  final model = ModelInfo(
      entities: _entities,
      lastEntityId: const IdUid(1, 1359946532989351171),
